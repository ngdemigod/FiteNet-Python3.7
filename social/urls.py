...
urlpatterns = [
    ...
    path('profile/<int:pk>/like', AddLike.as_view(), name='like'),
    path('profile/<int:pk>/dislike', AddDislike.as_view(), name='dislike'),
